...
- **FinalBurn Neo Full-Merged Sets** (completamente fusionados) significa que se incluyen todas las versiones de cada juego y los archivos de sistema requeridos para su emulacion en un único archivo `.zip`.
